...
export default function DisplayArtistInfo() {
  ...
  return (
    <>
      <div className="wrapper ArtistInfo  text-zinc-100 bg-zinc-800 p-5 pt-4 sm:w-3/4 md:w-3/5 mx-auto rounded-lg mb-10 ">
        <div className="upper-row flex flex-row flex-wrap gap-3 mb-5">
          <div className="headline w-full h-7 font-bold text-xl">
            {currentArtist.artistName}
          </div>
          <div className="upper-row gap-3 w-full flex flex-row">
            <Image
              src={currentArtist.imageUrl}
              alt="image of artist"
              width={200}
              height={200}
              className="image bg-zinc-900 h-52 w-3/5 rounded-lg object-cover"
            ></Image>
            <div className="stats-text bg-zinc-900 h-52 rounded-lg p-3 pl-4 pr-3 gap-2 flex flex-col">
              <div>
        ...
        <div className="lower-row h-64 flex flex-row flex-wrap gap-3">
          <div className="list bg-zinc-900 h-full rounded-lg p-3 gap-3 flex flex-col">
          ...
          <div className="text p-3 bg-zinc-900 h-full flex-grow-[8] mb-10 rounded-lg">
